...
type
  ...
  TPcscProtocol=(prNC, prT0, prT1, prMem, prRaw, prDirect);
(******************************************************************************)
...
(******************************************************************************)
  TSCardReaderStateA = record
    szReader: PChar;
    pvUserData: Pointer;
    dwCurrentState, dwEventState, cbAtr: DWord;
...
(******************************************************************************)
  TSCardIoRequest = packed record Protocol, Size: DWord; end;
...
(******************************************************************************)
  ERROR_LOADING_WINSCARD = 1;
  ERROR_LOADING_SCARDDLG = 2;
...
(******************************************************************************)
  ...
  SCARD_PROTOCOL_DEFAULT      = $80000000;  // Use implicit PTS.
                                            //   9600 Baud (und ggf andere
                                            //   default Wert, falls es noch
                                            //   was gibt?)
  SCARD_PROTOCOL_OPTIMAL      = $00000000;  // Use PTS to optimize protocol.
                                            //   Baudrate erkennen und dann
                                            //    die beste wählen.
  SCARD_PROTOCOL_Tx           = (SCARD_PROTOCOL_T0 or SCARD_PROTOCOL_T1);

  // this is our own value, not present in DDK/SKD files
...
(******************************************************************************)
  ...
  // our additional error codes
  DLL_ERROR = SCARD_F_INTERNAL_ERROR;
...
const
  READER_GETIFDTYPE		    = $12;
  IOCTL_CCID_ESCAPE		    = $0DAC; // SCARD_CTL_CODE
  IOCTL_GET_DEVICE_TYPE             = $0B06; // SCARD_CTL_CODE
  IOCTL_NEW_ESCAPE_IMPLEMENTATION   = $0850; // SCARD_CTL_CODE
  IOCTL_GET_VERSIONS                = $0801; // SCARD_CTL_CODE

  CCID_GET_PUPI_STATUS              = $FF9B;
  CCID_SET_PUPI_ON                  = $019B;
  CCID_SET_PUPI_OFF                 = $009B;
  ...
  IFDTYPE_SCR333                    = $107;
  IFDTYPE_SCR338                    = $108;
  IFDTYPE_SCR331DI                  = $109;
  IFDTYPE_SCR241                    = $10A;
  IFDTYPE_ELEKTRA331                = $10B;
  IFDTYPE_SPR332                    = $201;
  IFDTYPE_SPR132                    = $202;
  IFDTYPE_SPR532                    = $203;
  IFDTYPE_SPR336                    = $204;
  IFDTYPE_SPR337                    = $205;
  IFDTYPE_NMBNUMPAD                 = $300;


  IFDTYPE_CDX_I                     = $FFF0;
  IFDTYPE_CDX_I_OEM                 = $FFF1;
  IFDTYPE_CD_TERMINAL               = $FFF2;
  IFDTYPE_CDX_MAC                   = $FFF3;
  IFDTYPE_KARTENZWERG               = $FFF4;
  IFDTYPE_CDI                       = $FFF5;
  IFDTYPE_CDI_OEM                   = $FFF6;
  IFDTYPE_CDX_II                    = $FFF7;
  IFDTYPE_CD_TWIN                   = $FFF8;
  IFDTYPE_CD_MODUL                  = $FFF9;
  IFDTYPE_CDI_EJECT                 = $FFFA;
  IFDTYPE_CARD_READER               = $FFFB;
  IFDTYPE_CDM                       = $FFFC;
  IFDTYPE_CDM_OEM                   = $FFFD;
  IFDTYPE_SC_TERMINAL               = $FFFE;
  IFDTYPE_CDM_ADV                   = $FFFF;
